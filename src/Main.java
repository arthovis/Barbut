...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Zar Player 1");
            int zarPlayer1 = zarPlayer();
            System.out.println("Zar Player 2");
            ...
            System.out.println("Player 1's finances are: "+sumPlayer1);
            System.out.println("Player 2's finances are: "+sumPlayer2);
